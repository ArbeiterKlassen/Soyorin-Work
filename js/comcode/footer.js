...
insertHtml('        <div class="footer-line">Powered By <a href="https://github.com/arbeiterklassen/Soyorin-Work" target="_blank">Soyorin.Work - '+"AKlassen's Blogs</a> 浙ICP备1145141919810号• © 2025</div>")
//insertHtml('        <img src="../img/footer-cat.png" alt="" style="width: 100%;min-height: 250px;">')
insertHtml('    </footer>')
